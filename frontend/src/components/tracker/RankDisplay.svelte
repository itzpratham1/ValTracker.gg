<script>
  import { getRankImgUrl, RANK_COLORS, ACTS_TIMELINE, SEASONS_MAP, isCurrentAct, RANKS, computeActRank } from '../../lib/constants';
  ...
  $: displayRank = computeActRank(mmrData, selectedAct, stats?.recentMatches || [], $player.name, $player.tag);
